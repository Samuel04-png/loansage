  ...
  return (
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="text-neutral-600 mt-2">Access TengaLoans on all your devices</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Add TengaLoans to your home screen for quick access</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <ol className="list-decimal list-inside space-y-1 text-blue-800 text-sm">
                <li>Open TengaLoans in your browser</li>
                <li>Tap the menu button (three dots)</li>
                <li>Select "Add to Home Screen"</li>
                <li>Launch TengaLoans like a native app</li>
              </ol>
            </div>
            <div className="p-4 bg-purple-50 rounded-lg border border-purple-200">
              ...
              <ol className="list-decimal list-inside space-y-1 text-purple-800 text-sm">
                <li>Open TengaLoans in Chrome or Edge</li>
