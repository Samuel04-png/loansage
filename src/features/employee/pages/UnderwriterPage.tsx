...
import { Send, Paperclip, Loader2, CheckCircle2, Bot } from 'lucide-react';
        ...
        <Card className="bg-gradient-to-br from-slate-900 to-slate-800 text-white border-none">
          ...
          <CardContent>
            <p className="text-sm text-slate-300 mb-4">
              Powered by Google Gemini. Capable of analyzing collateral images, reading NRCs, and calculating implicit risk scores.
            </p>
